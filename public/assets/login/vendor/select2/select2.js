                ...
                Options.prototype.fromElement = function ($e) {
                    ...
                    if ($e.data("ajaxUrl")) {
                        if (
                            ...
                            console.warn(
                                "Select2: The `data-ajalivewire:components.url` attribute has been changed to " +
                                    "`data-ajalivewire:components.-url` and support for the old attribute will be removed" +
                                    " in future versions of Select2."
                            );
                        }

                        $e.attr("ajalivewire:components.-url", $e.data("ajaxUrl"));
                        $e.data("ajalivewire:components.-url", $e.data("ajaxUrl"));
                    }
