                                ...
                                null == this.options.multiple &&
                                    ...
                                    a.data("ajaxUrl") &&
                                        (this.options.debug &&
                                            ...
                                            console.warn &&
                                            console.warn(
                                                "Select2: The `data-ajalivewire:components.url` attribute has been changed to `data-ajalivewire:components.-url` and support for the old attribute will be removed in future versions of Select2."
                                            ),
                                        a.attr(
                                            "ajalivewire:components.-url",
                                            a.data("ajaxUrl")
                                        ),
                                        a.data(
                                            "ajalivewire:components.-url",
