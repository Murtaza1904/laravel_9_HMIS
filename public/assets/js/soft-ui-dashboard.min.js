            ...
            if (a) {
                ...
                s.querySelector("li:nth-child(" + i + ") .nav-link").onclick =
                    function () {
                        ...
                        let e = 0;
                        if (s.classList.contains("flelivewire:components.column")) {
    ...
    window.addEventListener("resize", function (e) {
        total.forEach(function (n, e) {
            ...
            if (s) {
                ...
                a = e.indexOf(s) + 1;
                let t = 0;
                if (n.classList.contains("flelivewire:components.column")) {
            ...
            window.innerWidth < 991
                ? total.forEach(function (e, t) {
                      e.classList.contains("flelivewire:components.column") ||
                          e.classList.add("flelivewire:components.column", "on-resize");
                  })
                : total.forEach(function (e, t) {
                      e.classList.contains("on-resize") &&
                          e.classList.remove("flelivewire:components.column", "on-resize");
                  });
    });
