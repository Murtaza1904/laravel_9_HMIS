    ...
    item.onmouseover = function (event) {
        ...
        if (li) {
            ...
            item.querySelector(
                ...
                let sum = 0;
                if (item.classList.contains("flelivewire:components.column")) {
...
window.addEventListener("resize", function (event) {
    ...
    if (window.innerWidth < 991) {
        total.forEach(function (item, i) {
            if (!item.classList.contains("flelivewire:components.column")) {
                item.classList.add("flelivewire:components.column", "on-resize");
            }
        });
    } else {
        total.forEach(function (item, i) {
            if (item.classList.contains("on-resize")) {
                item.classList.remove("flelivewire:components.column", "on-resize");
            }
        });
    }
});
...
function navbarFixed(el) {
    let classes = [
        ...
        "left-auto",
        "top-1",
        "z-indelivewire:components.sticky",
    ];
