            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/dashboard.html">
                        ...
                        <span class="nav-link-text ms-1">Calendee</span>
                    </a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/billing.html">
                        ...
                        <span class="nav-link-text ms-1">Flow Board</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/virtual-reality.html">
                        ...
                        <span class="nav-link-text ms-1">Recall Board</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('patients') }}">
                        ...
                        <span class="nav-link-text ms-1">Patient/Client</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/sign-up.html">
                        ...
                        <span class="nav-link-text ms-1">Procedures</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/sign-up.html">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/sign-up.html">
                        ...
                        <span class="nav-link-text ms-1">Popups</span>
                    </a>
                </li>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-12 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                <span>© Copyright {{ date('Y') . ' ' . config('app.name') }},made by</span>
                                <a href="{{ url('https://www.linkedin.com/in/muhammad-murtaza-3099081a7/') }}"
                                    class="font-weight-bold" target="_blank">Muhammad Murtaza</a>
                            </div>
                        </div>
                    </div>
                </div>
