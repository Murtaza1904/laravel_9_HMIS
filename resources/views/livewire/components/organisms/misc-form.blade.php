<div class="card-body plivewire:components.0 pt-0 pb-2">
    <form class="container">
        ...
        <div class="row">
            <div class="col">
                <livewire:components.molecules.input-field label="Date Deceased" type="date" name="misc.date_deceased"
                    placeholder="Enter date deceased" errorName="misc.date_deceased" message="$message" />
            </div>
            <div class="col">
                <livewire:components.molecules.input-field label="Reason Deceased" type="date" name="misc.reason_deceased"
