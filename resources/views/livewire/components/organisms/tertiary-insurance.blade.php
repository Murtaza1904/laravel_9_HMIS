<div class="card-body plivewire:components.0 pt-0 pb-2">
    <form class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.input-field label="Plan Name" type="text" name="tertiary_insurance.plan_name"
                    placeholder="Enter plan name" errorName="tertiary_insurance.plan_name" message="$message" />
            </div>
        </div>
        <div class="row">
            <div class="col">
                <livewire:components.molecules.input-field label="Subscriber" type="text" name="tertiary_insurance.subscriber"
        ...
        <div class="row">
            <div class="col">
                <livewire:components.molecules.select-field label="Relationship" selectName="tertiary_insurance.relationship"
                    errorName="tertiary_insurance.relationship" message="$message" />
            </div>
            <div class="col">
                <livewire:components.molecules.input-field label="Policy Number" type="number" name="tertiary_insurance.policy_number"
                    placeholder="Enter policy number" errorName="tertiary_insurance.policy_number"
                    message="$message" />
            </div>
            <div class="col">
                <livewire:components.molecules.input-field label="Date OF Birth" type="date" name="tertiary_insurance.date_of_birth"
        ...
        <div class="row">
            <div class="col">
                <livewire:components.molecules.input-field label="Group Number" type="number" name="tertiary_insurance.group_number"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.radio-field label="Gender" radioName="tertiary_insurance.gender"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.input-field label="Subscriber Address" name="tertiary_insurance.gender"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.select-field label="Country" selectName="tertiary_insurance.country"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.select-field label="City" selectName="tertiary_insurance.city"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.select-field label="state" selectName="tertiary_insurance.state"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.input-field label="Zip Code" type="number" name="tertiary_insurance.zipcode"
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:components.molecules.input-field label="Co-Payment" type="number" name="tertiary_insurance.co_payment"
