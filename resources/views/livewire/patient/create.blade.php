 @if ($contact_form)
     @include('livewire.patient.register.contact_form')
     {{-- @elseif($createMode)
        @include('livewire.patient.create') --}}
 @else
     <button type="submit" wire:click.prevent="contact_form" class="btn btn-primary">Contact</button>
     <div class="card-header pb-0">
         <h6 class="text-primary">Add New Patient</h6>
     </div>
