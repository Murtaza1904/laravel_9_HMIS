<div class="card-body plivewire:components.0 pt-0 pb-2">
    <form class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Plan Name" type="text" name="primary_insurance.plan_name"
                    placeholder="Enter plan name" errorName="primary_insurance.plan_name" message="$message" />
            </div>
        </div>
        <div class="row">
            <div class="col">
                <x-molecules.input-field label="Subscriber" type="text" name="primary_insurance.subscriber"
        ...
        <div class="row">
            <div class="col">
                <x-molecules.select-field label="Relationship" selectName="primary_insurance.relationship"
                    errorName="primary_insurance.relationship" message="$message" />
            </div>
            <div class="col">
                <x-molecules.input-field label="Policy Number" type="number" name="primary_insurance.policy_number"
                    placeholder="Enter policy number" errorName="primary_insurance.policy_number" message="$message" />
            </div>
            <div class="col">
                <x-molecules.input-field label="Date OF Birth" type="date" name="primary_insurance.date_of_birth"
                    placeholder="Enter date of birth" errorName="primary_insurance.date_of_birth" message="$message" />
            </div>
        </div>
        <div class="row">
            <div class="col">
                <x-molecules.input-field label="Group Number" type="number" name="primary_insurance.group_number"
        ...
        <div class="row">
            ...
            <div class="col">
                {{-- <x-molecules.radio-field label="Gender" radioName="primary_insurance.gender" errorName="primary_insurance.gender" message="$message" /> --}}
            </div>
        </div>
        <div class="row">
            <div class="col">
            ...
            <div class="col">
                <x-molecules.input-field label="Subscriber Address" name="primary_insurance.gender"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.select-field label="Country" selectName="primary_insurance.country"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.select-field label="City" selectName="primary_insurance.city"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.select-field label="state" selectName="primary_insurance.state"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Zip Code" type="number" name="primary_insurance.zipcode"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Co-Payment" type="number" name="primary_insurance.co_payment"
