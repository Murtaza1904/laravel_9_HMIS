<div class="card-body plivewire:components.0 pt-0 pb-2">
    <form class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Plan Name" type="text" name="secondary_insurance.plan_name"
                    placeholder="Enter plan name" errorName="secondary_insurance.plan_name" message="$message" />
            </div>
        </div>
        <div class="row">
            <div class="col">
                <x-molecules.input-field label="Subscriber" type="text" name="secondary_insurance.subscriber"
        ...
        <div class="row">
            <div class="col">
                <x-molecules.select-field label="Relationship" selectName="secondary_insurance.relationship"
                    errorName="secondary_insurance.relationship" message="$message" />
            </div>
            <div class="col">
                <x-molecules.input-field label="Policy Number" type="number" name="secondary_insurance.policy_number"
                    placeholder="Enter policy number" errorName="secondary_insurance.policy_number" message="$message" />
            </div>
            <div class="col">
                <x-molecules.input-field label="Date OF Birth" type="date" name="secondary_insurance.date_of_birth"
                    placeholder="Enter date of birth" errorName="secondary_insurance.date_of_birth" message="$message" />
            </div>
        </div>
        <div class="row">
            <div class="col">
                <x-molecules.input-field label="Group Number" type="number" name="secondary_insurance.group_number"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Subscriber Address" name="secondary_insurance.gender"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.select-field label="Country" selectName="secondary_insurance.country"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.select-field label="City" selectName="secondary_insurance.city"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.select-field label="state" selectName="secondary_insurance.state"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Zip Code" type="number" name="secondary_insurance.zipcode"
        ...
        <div class="row">
            ...
            <div class="col">
                <x-molecules.input-field label="Co-Payment" type="number" name="secondary_insurance.co_payment"
